...
const styles = StyleSheet.create({
    ...
    viewNumList: responsive => ({
        width: responsive.size(67),
        height: '100%',
    ...
    txtExpand:(responsive, childItem,propsItem, prop_id) =>({
        fontSize: responsive.fontSize(12), 
        textAlign: 'left', 
